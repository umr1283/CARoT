# Getting help with CARoT

Thanks for using CARoT. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/CARoT/issues) to make sure the 
