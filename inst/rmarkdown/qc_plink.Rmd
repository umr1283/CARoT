...
**`r scales::comma(sum(eigenvec_pca[["extremes"]]))`** samples were labeled and flagged as being extreme 
(greater than `r qdap::replace_number(params[["pca_threshold"]])` times the standard deviation 
from the centroid of **`r params[["cohort_name"]]`** on the first two principal components), 
this is illustrated in Figure \@ref(fig:population-06).
