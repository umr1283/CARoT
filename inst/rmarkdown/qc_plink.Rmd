...
```{r population-03, fig.height = 4.7 * 1.5, fig.cap = paste("First factorial plane computed with a combined dataset", "involving samples from the 1,000 Genomes Project.", "Samples in A were colored by super population groups,", "whereas samples in B were colored by population groups", "and focused on the PCA area of studied cohort.")}
