...
ggplot2::ggplot(
  ...
  ggplot2::geom_rect(
    mapping = ggplot2::aes(xmin = -Inf, xmax = -0.2, ymin = -Inf, ymax = Inf), 
    fill = "firebrick2",
    alpha = 0.10,
    colour = "transparent"
  ) +
  ggplot2::geom_rect(
    mapping = ggplot2::aes(xmin = -0.2, xmax = 0.2, ymin = -Inf, ymax = Inf), 
    fill = "firebrick2",
    alpha = 0.25,
    colour = "transparent"
  ) +
  ggplot2::geom_rect(
    mapping = ggplot2::aes(xmin = 0.8, xmax = 1, ymin = -Inf, ymax = Inf), 
    fill = "dodgerblue",
    alpha = 0.25,
    colour = "transparent"
  ) +
...
**`r scales::comma(sum(eigenvec_pca[["extremes"]]))`**
...
Samples labeled and flagged as extreme: **`r params[["cohort_name"]]`**.
