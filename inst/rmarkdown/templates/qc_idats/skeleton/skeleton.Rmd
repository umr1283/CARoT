...
readr::write_csv(norm_beta, path = file.path(output_directory, paste0(params[["array"]], "_QC_betavalues.csv")))
readr::write_csv(norm_beta, path = file.path(output_directory, paste0(params[["array"]], "_QC_phenotypes.csv")))
```
