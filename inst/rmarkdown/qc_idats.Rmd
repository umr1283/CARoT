...
* `filter_beads`: `r params[["filter_beads"]]`  
    => should probes with a low beadcounts be removed?
...
* The method to estimate background normal distribution parameters: `r params[["norm_background"]]`  
    => methods from [*ENmix*](https://doi.org/doi:10.18129/B9.bioc.ENmix)
...
* The cell tissue: `r params[["cell_tissue"]]`  
    => using reference panel or `RefFreeCellMix` method from [*RefFreeEWAS*](https://cran.r-project.org/package=RefFreeEWAS)
